...
function ContactForm() {
  ...
  const handleSendMail = async (e) => {
    ...
    try {
      setIsLoading(true);
      const response = await fetch("https://shiftapi.onrender.com/api/contact", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ ...userInput, source: "portfolio" }), // Set "portfolio" or "shiftSwiftly"
      });
      ...
      toast.error(`Error: ${err.message}`, { position: "bottom-right" });
    } finally {
      setIsLoading(false);
    }
  };
